...
### URN methods generated by `define_aggregate!`

When you use `define_aggregate!` with a `namespace:` key, the generated `XxxUrn` type receives
additional constructor and accessor methods on top of everything `#[derive(Urn)]` provides:
...
define_aggregate! {
    BankAccount {
        ...
        state: { balance: f64 },
        commands: { Deposit { amount: f64 } },
        events: { Deposited { amount: f64 } }
    }
}
